...
.PHONY: help install build typecheck test e2e act-list ci
...
ci: typecheck build test ## Local CI checks (typecheck + vite build + vitest). Use 'make e2e' for integration.
