...
- [ ] **Empty-tree parses — parser yield fixes** · CRITICAL → `progress/empty-tree-parses.md` — 8 diagnosed root causes on a measured step plan (yield harness + goldens; steps 0–5 landed 2026-08-24, yield 77.8%→96.8% offline, `java` 0→783/785); next: step 6 (link-headings, incl. `useful-javascript-libraries`). The webapp hollow-registry stock rides this thread.
